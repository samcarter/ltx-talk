...
% This example only makes sense for Unicode engines, so we check for that:
% Use the built-in function.
\ExplSynaxOn
\cs_new_eq:NN \IfUnicodeEngineTF \sys_if_engine_unicode:TF
\ExplSyntaxOff
\IfUnicodeEngineTF
  {\usepackage{fontspec}}
  {\PackageError{ltx-talk-examples}{This example only works with Unicode engines!}{}}
