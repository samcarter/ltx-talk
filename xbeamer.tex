...
\begin{itemize}
  \item The basic structure of a presentation is made up of |frame|
...
The following key differences between \pkg{beamer} and \pkg{xbemaer} are
...
number ranges in angle brackets that is put after certain commands as in
