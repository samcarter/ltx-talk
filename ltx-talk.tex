...
and math mode material, \LuaTeX{} users are strongly encouraged to choice a
font available with Unicode math support. A demonstration of the majority of
current options in this area is available at
\url{https://mathfonts.github.io/latex-table.html}, where you can also try out
the appearance of expressions you choose.
