...
This template is used to create enviornments which map to the floats in a
...
template is \texttt{talk}, which recongizes the keys
\begin{itemize}
  \item \opt{float-placement} Ingored at present
...
arguments. The standard template is \texttt{talk}, which recongizes the keys
\begin{itemize}
  ...
  \item \opt{left-skip} Margin on left of footer
  \item \opt{right-skip} Margin on right of footer
  \item \opt{separator} Tokens inserted between elemeents.
\end{itemize}
